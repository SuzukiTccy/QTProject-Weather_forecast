...
"}"));
        ...
        label_4->setStyleSheet(QString::fromUtf8("font: 22pt \"Arial\";\n"
...
"font: 38pt"));
        ...
        sunRiseSetLb = new QSunRiseSet(widget);
        sunRiseSetLb->setObjectName("sunRiseSetLb");
        sunRiseSetLb->setGeometry(QRect(187, 336, 150, 100));
